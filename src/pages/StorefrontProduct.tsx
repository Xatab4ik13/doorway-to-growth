    ...
    <StorefrontLayout site={site}>
      <div className="min-h-screen pt-14 md:pt-0 bg-[#07090d]">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 py-8 md:py-14">
          ...
          {/* ===== MAIN: GALLERY + INFO ===== */}
          <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,480px)_1fr] gap-8 lg:gap-14">
            ...
            >
              <div className="relative aspect-[3/4] max-h-[65vh] bg-[#0c0e14] overflow-hidden group rounded-2xl">
