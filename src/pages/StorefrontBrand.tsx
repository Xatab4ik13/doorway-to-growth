...
const ADVANTAGES = [
  ...
  { title: "Сервис от А до Я", desc: "От платного замера до монтажа под ключ" },
];
...
export default function StorefrontBrand() {
  ...
  return (
    <StorefrontLayout site={site}>
      {/* ═══════════ HERO ═══════════ */}
      <section className="relative min-h-[60vh] md:min-h-[80vh] flex items-center overflow-hidden" style={{ backgroundColor: "#07090D" }}>
