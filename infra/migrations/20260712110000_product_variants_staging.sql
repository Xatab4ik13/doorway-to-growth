-- Mirror of Lovable Cloud migration: adds is_stale flag on product_images and
-- creates the product_variants_staging table used by the CRM audit screen.
...
DROP POLICY IF EXISTS "Admins can view variant staging" ON public.product_variants_staging;
DROP POLICY IF EXISTS "Admins can insert variant staging" ON public.product_variants_staging;
DROP POLICY IF EXISTS "Admins can update variant staging" ON public.product_variants_staging;
DROP POLICY IF EXISTS "Admins can delete variant staging" ON public.product_variants_staging;
...
DROP TRIGGER IF EXISTS update_product_variants_staging_updated_at ON public.product_variants_staging;
